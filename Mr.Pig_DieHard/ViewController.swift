...
class ViewController: UIViewController {
  ...
  func setupNodes() {
    ...
    // Collision detection setting up nodes
  ...
  func setupGestures() {
    ...
    let swipeForward:UISwipeGestureRecognizer = UISwipeGestureRecognizer(target: self, action: #selector(ViewController.handleGestures(_:)))
    swipeForward.direction = .Up
    scnView.addGestureRecognizer(swipeForward)
    
    let swipeBackward:UISwipeGestureRecognizer = UISwipeGestureRecognizer(target: self, action: #selector(ViewController.handleGestures(_:)))
